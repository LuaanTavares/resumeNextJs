export const About = () => {
  return(
    <section className=" text-slate-200 flex justify-center mx-auto px-2 px-6 md:py-20 max-md:py-6">
        <div className="flex justify-center gap-10 md:gap-24 p-4 rounded-lg bg-neutral-800 bg-opacity-40 max-md:flex-col">
          <div className="flex flex-col md:w-2/3 max-md: items-center gap-8">
            ...
            <p>
               Estou no mercado de trabalho desde 2014, quando trabalhei por 2 anos como Estoquista 
               na Loja Fist Class Cama, Mesa e Banho (2014 - 2015). Depois trabalhei por 7 anos na empresa Santo Antônio Transportes, 
               ...
               Essas competências podem ser confirmadas no meu repositório do GitHub, que contém alguns dos meu projetos. 
               Pensando em facilitar a análise do meu repositório, separei abaixo 3 projetos como demonstração.
