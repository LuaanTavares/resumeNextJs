  ...
  return(
    ...
    <div className="flex justify-around items-center w-full max-md:justify-between py-2 px-4">
      ...
      <ul className= {`text-slate-200 flex text-xl font-normal gap-3 justify-center items-center max-md:hidden`}>
        ...
        <a href="#about"><li className="w-14 flex justify-center hover:font-semibold duration-75">About</li></a>
        <a href="#projects"><li className="w-20 flex justify-center hover:font-semibold duration-75">Projects</li></a>
    ...
    <ul className= {`text-slate-50 flex flex-col text-xl gap-3 justify-center py-4 items-center md:hidden bg-opacity-80 ${scroll ? ' bg-black' : 'bg-neutral-900 &&'} ${isCloseOrOpen ? 'visible':'hidden' }`}>
      <a href="#main"><li className="w-20 flex justify-center hover:font-semibold duration-75" onClick={openNavBar}>Main</li></a>
      <a href="#about"><li className="w-20 flex justify-center hover:font-semibold duration-75" onClick={openNavBar}>About</li></a>
      <a href="#projects"><li className="w-24 flex justify-center hover:font-semibold duration-75" onClick={openNavBar}>Projects</li></a>
      <a href="#skills"><li className="w-20 flex justify-center hover:font-semibold duration-75" onClick={openNavBar}>Skills</li></a>
      <a href="#education"><li className="w-24 flex justify-center hover:font-semibold duration-75" onClick={openNavBar}>Education</li></a>
      <a href="#courses"><li className="w-20 flex justify-center hover:font-semibold duration-75" onClick={openNavBar}>Courses</li></a>
      <a href="#footer"><li className="w-20 flex justify-center hover:font-semibold duration-75" onClick={openNavBar}>Footer</li></a>
    </ul>
